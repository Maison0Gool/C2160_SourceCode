...
public class SpriteSheet {
    ...
    public SpriteSheet(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.gamespritesheet, bitmapOptions);
    }

    public Sprite[] getPlayerSpriteArray() {
        Sprite[] spriteArray = new Sprite[3];
        spriteArray[0] = new Sprite(this, new Rect(0*64, 0, 1*64, 50));
        spriteArray[1] = new Sprite(this, new Rect(1*64, 0, 2*64, 50));
        spriteArray[2] = new Sprite(this, new Rect(2*64, 0, 3*64, 50));
        return spriteArray;
    }
